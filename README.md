[![Run App Schwarz, Alex](https://github.com/curtainman/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/curtainman/GithubActions/actions/workflows/ci.yml)
